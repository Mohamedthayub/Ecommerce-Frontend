        ...
        <div className="flex item-center justify-between py-5 font-medium ">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group relative">
                    ...
                    <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 sm:p-2">
                        <div className="flex flex-col gap-2 w-36 py-5 px-5 bg-slate-100 text-gray-500 rounded-md">
                ...
                <Link to='/cart' className="relative">
                    ...
                    <p className="absolute right-[-1px] bottom-[-3px]   w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]">10</p>
                </Link>
            ...
            <div className={`absolute  top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>    
                <div className="flex flex-col text-gray-600">
                    ...
                    <NavLink className='py-2 pl-6 border' to='/collection'  onClick={() => setVisible(false)} >COLLECTIONS</NavLink>
